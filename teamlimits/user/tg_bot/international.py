...
1. extract messages from code to generate template .teamlimits/user/tg_bot/locales/messages.pot
pybabel extract --input-dirs=teamlimits/user/tg_bot -o teamlimits/user/tg_bot/locales/messages.pot

2. update po files:
pybabel update -d teamlimits/user/tg_bot/locales -D messages -i teamlimits/user/tg_bot/locales/messages.pot
...
4: compile mo files:
pybabel compile -f -d teamlimits/user/tg_bot/locales -D messages
